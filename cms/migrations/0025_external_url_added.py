...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Title.external_url'
        db.add_column('cms_title', 'external_url', orm['cms.title:external_url'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Title.external_url'
        db.delete_column('cms_title', 'external_url')
